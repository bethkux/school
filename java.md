...
Zpět na [Zkouškové_úlohy](#Zkouškové_úlohy). Většinou jsou pokryty v kapitolách výše, nebo se jedná o jednoduché věci jako "equals u objektů".
...
**10. Napište čítač (long) s metodami inc() a get(), který bude thread-safe.**
